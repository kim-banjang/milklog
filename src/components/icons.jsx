...
export const HomeIcon = ({ size = 24 }) => ic(
  <>
...
export const NoteIcon = ({ size = 24 }) => ic(
  <>
    <rect x="5" y="3.5" width="14" height="17" rx="3.2" />
    <path d="M8.6 8.5h6.8M8.6 12h6.8M8.6 15.5h4.2" />
  </>, { size });

export const PersonIcon = ({ size = 24 }) => ic(
  <>
    <circle cx="12" cy="8.2" r="3.5" />
    <path d="M5.5 19.5c0-3.4 2.9-5.6 6.5-5.6s6.5 2.2 6.5 5.6" />
  </>, { size });

export const PlusIcon = ({ size = 24 }) => ic(<><path d="M12 6v12M6 12h12" /></>, { size, sw: 2.2 });
export const MinusIcon = ({ size = 24 }) => ic(<><path d="M6 12h12" /></>, { size, sw: 2.2 });

export const BellIcon = ({ size = 24 }) => ic(
  <>
    <path d="M6.5 10a5.5 5.5 0 0 1 11 0c0 4 1.3 5.3 2 6H4.5c.7-.7 2-2 2-6Z" />
    <path d="M10 19.5a2.2 2.2 0 0 0 4 0" />
  </>, { size });

export const TrashIcon = ({ size = 18 }) => ic(
  <>
...
export const ChevronDown = ({ size = 20 }) => ic(<><path d="M6 9.5 12 15l6-5.5" /></>, { size, sw: 2 });
export const ChevronRight = ({ size = 20 }) => ic(<><path d="M9.5 6 15 12l-5.5 6" /></>, { size, sw: 2 });
export const ChevronLeftSm = ({ size = 20 }) => ic(<><path d="M14.5 6 9 12l5.5 6" /></>, { size, sw: 2 });

export const CalendarIcon = ({ size = 20 }) => ic(
  <>
    <rect x="4" y="5.5" width="16" height="15" rx="3.2" />
    <path d="M4 10h16M8.5 3.5v4M15.5 3.5v4" />
  </>, { size, sw: 1.8 });

export const DropIcon = ({ size = 20 }) => ic(
